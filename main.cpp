...
int main() {
  ...
  auto light1 = std::make_shared<AreaLight>(RGB(0, 10, 10), sphere2);
  lights.push_back(light1);

  std::vector<std::shared_ptr<Primitive>> prims;
  auto prim1 = std::make_shared<Primitive>(floor, mat);
  auto prim2 = std::make_shared<Primitive>(sphere1, mat2);
  auto prim3 = std::make_shared<Primitive>(sphere2, mat2, light1);
  auto prim4 = std::make_shared<Primitive>(sphere3, mat2);
